        ...
        <section id='neocode'>
            ...
            <div className="values">
                ...
                <ul style={{listStyle: 'revert'}}>
                    <br/>
                    <li>
                        <p>Inovação: Somos apaixonados por inovar e encontrar soluções criativas que resolvem problemas.<br/><br/></p>
                    </li>
                    <li>
                        <p>Qualidade: Estamos comprometidos em entregar produtos e serviços de alta qualidade que excedem as expectativas dos clientes.<br/><br/></p>
                    </li>
                    <li>
                        <p>Transparência: Somos 100% transparentes em nossa comunicação com os clientes, para que saibam exatamente o que estão recebendo e como estamos trabalhando para atender suas necessidades.<br/><br/></p>
                    </li>
                    <li>
                        <p>Ética: Agimos com integridade e ética em todas as nossas operações, respeitando os direitos e privacidade dos clientes, funcionários e parceiros.
                    ...
                    <li>
                        <p>Foco no cliente: Estamos sempre focados em atender às necessidades dos clientes e fornecer soluções personalizadas e eficazes para seus problemas, garantindo sua satisfação e fidelidade.<br/><br/></p>
                    </li>
                </ul>
                <p>Em cada projeto, em cada interação com nossos clientes, e em todas as nossas decisões, nossos valores norteiam nossas ações e refletem a cultura de nossa empresa.</p>
                <br/><br/><br/>
                <hr/>
            </div>
        </section>
